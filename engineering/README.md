...
- **[to-prd](./to-prd/SKILL.md)** — Turn the current conversation context into a PRD under `.scratch/<feat>/`. Defaults to writing a superseding `PRD-vN.md` when an existing PRD matches.
